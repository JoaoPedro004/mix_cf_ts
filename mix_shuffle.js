...
registerPlugin(
  ...
  function (sinusbot, config) {
    ...
    // Preserva qualquer prefixo existente no nome (ex: [cspacer])
    var filaNamePrefix = (function() {
      var ch = getChannel(config.filaChannelId);
      if (!ch) return "";
      var name = ch.name();
      // Extrai tudo até o primeiro emoji ou letra (preserva spacers e prefixos)
